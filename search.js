...
// 89 30 25 32 72 70 51 42 25 24 53 55 78 50 13 40 48 32 26 2 14 33 45 72 56 44 21 88 27 68 15 62 93 98 73 28 16 46 
// 87 28 65 38 67 16 85 63 23 69 64 91 9 70 81 27 97 82 6 88 3 7 46 13 11 64 76 31 26 38 28 13 17 69 90 1 6 7 64 43 
...
// Then implement a binary search to find a particular value in the dataset. Display how many tries it took to search for a 
// particular item in the dataset using binary search. If the item is not in the dataset, provide a message and indicate 
...
//  25 15 50 10 24 35 70 4 12 18 31 44 66 90 22. Then implement inOrder(), preOrder(), and postOrder() functions. 
...
// Commander Riker is directly responsible for Worf and LaForge. People of the same rank are at the same level in the tree. 
// However, to distinguish between people of the same rank, those with more experience are on the left and those with less 
// on the right (i.e., experience decreases from left to right). Suppose a fierce battle with an enemy ensues. 
...
// Imagine that you wanted to find the highest floor of a 100 story building that you could drop an egg from 
// without the egg breaking. 
// But you only have 2 eggs. Write an algorithm to find out in the most efficient way which floors you should drop the eggs from. 
// After you have understood the question and made some attempts to solve the problem, 
// go through this reading before you start coding: http://datagenetics.com/blog/july22012/index.html.